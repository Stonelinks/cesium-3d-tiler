...
// Set BABEL_ENV to development as per https://github.com/facebookincubator/create-react-app/issues/2377
...
module.exports = [
  {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.(png|gif|jpg|jpeg|eot|woff|woff2|ttf|svg|xml|json)$/,
          use: ["url-loader"]
        },
        {
          test: /\.js$/,
